...
export const OFFICE_CLEANING_SERVICES: readonly OfficeCleaningService[] = [
  {
    ...
    description:
      "Complete professional cleaning for workstations, floors, glass, cabins and shared office areas.",
    rating: 4.9,
    reviewCount: 1386,
    duration: "4–8 hrs",
    rate: 6,
  ...
  },
  {
    ...
    description:
      "Machine-assisted floor cleaning for corporate offices and large professional workplaces.",
    rating: 4.8,
    reviewCount: 924,
    duration: "3–6 hrs",
    rate: 5,
  ...
  },
  {
    ...
    description:
      "Flexible cleaning for shared desks, meeting rooms, lounges and high-touch surfaces.",
    rating: 4.8,
    reviewCount: 782,
    duration: "3–5 hrs",
    rate: 5,
  ...
  },
  {
    ...
    description:
      "Hygiene-focused deep cleaning for office pantries, washrooms and connected common areas.",
    rating: 4.9,
    reviewCount: 668,
    duration: "2–5 hrs",
    rate: 4,
  ...
  },
  {
    ...
    description:
      "Professional carpet shampooing with deep vacuuming, stain treatment and moisture extraction.",
    rating: 4.8,
    reviewCount: 596,
    duration: "3–6 hrs",
    rate: 5,
...
export function calculateOfficeCleaningPlan(
  input: unknown,
): OfficeCleaningPlan | null {
  ...
  const service = OFFICE_CLEANING_SERVICES.find(
    (item) => item.id === raw.id,
  );
  ...
  const lineTotal = calculateOfficeCleaningEstimate(
    service,
    raw.quantity,
  );
