...
export async function POST(request: Request) {
  try {
    ...
    if (isDynamicPlan) {
      const customPlan = isCommercialCleaningPlan
      ...
      if (!customPlan) {
        const message = isCommercialCleaningPlan
      ...
      serviceName = isCommercialCleaningPlan
    ...
    const customPlanType = isCommercialCleaningPlan
      ? "commercial"
      : isIndustrialCleaningPlan
        ? "industrial"
        : isCustomBathroomCleaning
